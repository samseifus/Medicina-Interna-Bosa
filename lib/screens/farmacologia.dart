      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return ListTile(
            ...
            subtitle: Text(
                'Dosis inicial: ${medicamento.dosisInicioYPorHoras} - Dosis máxima: ${medicamento.dosisMaxima} - Inicio: ${medicamento.inicio}'),
            onTap: () {
              showDialog(
                context: context,
                  ...
                  return AlertDialog(
                    ...
                    content: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          Text('Dosis inicial: ${medicamento.dosisPorKg}\n'),
                          Text('Dosis inicial: ${medicamento.dosisInicioYPorHoras}\n'),
                          ...
                          Text('Dosis inicial: ${medicamento.precauciones}\n'),
                          Text('Dosis inicial: ${medicamento.contraindicaciones}\n'),
                          Text('Dosis inicial: ${medicamento.Sobredosis}\n'),
                        ],
                      ),
                    ),
                  );
